...
/*
   ...
   limitation). ecl_kw_fwrite will fail (with error) message if attempting
   write kw of more than 8. ecl_kw_grdecl is a workaround enabling possible
   reading/writing kw with longer headers. 
